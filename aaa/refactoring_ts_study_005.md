...
「TypeScriptは初級～中級」「リファクタリング  は初めて」「設計は超入門者」を前提としてください。
...
【出力ルール（厳守）】
- 返答の冒頭にて、「お気持ち表明」「方向性の宣言」を一切書かないこと
解答は「章のヘッダー」から始まります。

解答内容はそのまま「第３者が見る教材ページ」となりますので、
解答内容の先頭に「AIであるあなたが、私だけに対して宛てた返信内容は含まないようにしてください」
たとえば、
- 文頭に「了解！ ◯◯の方向性にしますね！」といった報告や
- 文末に「このまとめを使って、さらにこういった方向にもできるよ！」といった内容は
教材内容というよりも、私個人への提案となります、そういったものは返答に含め内容にしましょう。

このような「あなたのお気持ち表明」は不要です。
